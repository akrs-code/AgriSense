...
export const FarmerDashboard: React.FC = () => {
  ...
  const totalRevenue = farmerCrops.reduce((sum, crop) => sum + (crop.quantity * crop.pricePerUnit), 0);
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">New crop listing added</p>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-green-50 rounded-lg">
            <p className="text-sm font-medium text-green-800">Rice (Central Luzon)</p>
            <p className="text-xl font-bold text-green-900">₱42/kg</p>
            <p className="text-xs text-green-600">+5% from last week</p>
          </div>
          
          <div className="p-4 bg-blue-50 rounded-lg">
            <p className="text-sm font-medium text-blue-800">Corn (Nueva Ecija)</p>
